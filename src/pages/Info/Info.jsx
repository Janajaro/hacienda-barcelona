        ...
        <div className="main-container-info">
            <div className="info-wrapper">
                    ...
                    <div className="info-wrapper-imgs">
                        ...
                        <img src="/images/HB-horizont7.jpg" alt="hacienda-barcelona-info-photo" />
                        <img src="/images/HB-V-1.jpg" alt="hacienda-barcelona-info-photo" />
                        <img src="/images/HB-horizont6.jpg" alt="hacienda-barcelona-info-photo" />
                        <img src="/images/HB-V-2.jpg" alt="hacienda-barcelona-info-photo" />

                    </div>

                    <div className="info-wrapper-texts">

                        {currentTexts.map((oneText) => {
                            return (
                                <div key={oneText.header}>
